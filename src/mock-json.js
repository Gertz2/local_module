const scheme = {
  ...
  sidebar: {
    ...
    title: "ЧелГУ",
    menuItems: [
      { icon: "/un_icon2.png", text: "Мои Курсы", link: "/" },
      { icon: "/archive.png", text: "Архив", link: "/archive" },
      { icon: "/calendar.png", text: "Календарь", link: "/calendar" },
      {
        icon: "/request_quote_1.png",
        text: "Запрос на создание курса",
        link: "/request",
      },
    ],
  },
  ...
  coursesBlock: {
    filters: {
      ...
      direction: ["Все направления", "МТ", "МП", "МК", "МН"],
    ...
    courses: [
      {
        ...
        description: "Описание курса Математический анализ",
        teacher: "Панов А.В.",
        year: "2024-2025",
        direction: "МТ",
        group_number: "201",
      ...
      },
      {
        ...
        type: "Лекционный курс",
        description: "Описание курса Дискретная математика",
      ...
      {
        course_id: 9,
        subject: "Технология баз данных",
        type: "Практический курс",
        description: "Описание курса Технехнология баз данных",
  ...
  courseDetails: {
    currentCourse: {
      ...
      subject: "Математический анализ",
      type: "Лекционный курс",
      course_description: "Описание курса Математический анализ",
      teacher: {
        name: "Панов А.В.",
        position: "Профессор",
